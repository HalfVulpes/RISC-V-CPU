# DDR4 SDRAM pin placement - RK-XCKU5P-F V1.2
# Bank 65: address/control (HP, 1.2V)  Bank 64: data (HP, 1.2V)
# Port names match Vivado BD wrapper for ddr4_sdram_c0 interface.

# --- Address [0:16] (A14=CAS_B, A15=RAS_B, A16=WE_B in DDR4 cmd encoding) ---
...
set_property PACKAGE_PIN AA25 [get_ports {ddr4_sdram_c0_adr[14]}]
set_property PACKAGE_PIN T25  [get_ports {ddr4_sdram_c0_adr[15]}]
set_property PACKAGE_PIN P23  [get_ports {ddr4_sdram_c0_adr[16]}]
...
# BG[1] not present on MT40A512M16LY-062E (x16 device has only BG[0]).
# MIG generates bg[1] for scheduling; routed to DDR4_PARITY (Y23, Bank 65).
# FPGA drives LOW always; DDR4 PAR=0 = parity disabled (default MIG config).
set_property PACKAGE_PIN Y23  [get_ports {ddr4_sdram_c0_bg[1]}]
...
# --- DQS differential strobes (Bank 64) ---
