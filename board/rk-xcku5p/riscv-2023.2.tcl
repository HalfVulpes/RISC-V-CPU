...
proc create_hier_cell_DDR { parentCell nameHier } {
  ...
  # DDR4 UI clock (333.25 MHz) → SmartConnect aclk1 + exposed to root for clk_wiz_0
...
proc create_root_design { parentCell } {
  ...
  # clk_wiz_0: 333.25 MHz input from DDR4 UI clock (No_buffer)
  #   clk_out1 = 125 MHz (approx 124.97 MHz — slight deviation from exact)
  #   clk_out2 = 125 MHz @90° (phase-aligned with clk_out1)
  #   clk_out3 = 100 MHz (approx 99.98 MHz)
  # The deviation comes from UI_CLK = 1000/3 = 333.25 MHz (not exact integer).
  # We accept <0.03% frequency error — within the tolerance of RGMII timing
  # and the SD card's 50 MHz clock budget.
  set clk_wiz_0 [create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_0]
  set_property -dict [list \
    CONFIG.PRIM_SOURCE              {No_buffer}  \
    CONFIG.PRIM_IN_FREQ             {333.25}     \
  ...
  # DDR4 UI clock (333.25 MHz) → clk_wiz_0 for user/AXI/ETH clocks
